...
public sealed class NavigateToTool : JsonReadTool<NavigateToTool.Args, NavigationOutcome>
{
    ...
    public override ToolDescriptor Descriptor { get; } = ToolDescriptor.WithStaticSchema(
        ...
        """{"type":"object","properties":{"mode":{"type":"string","enum":["landing","portal","search","research","storage","notebook","fitsViewer","cubeViewer","aiGuide","workflows"]}},"required":["mode"],"additionalProperties":false}""");
